...
/**
 *
 * @author github.com/sinanozclk
 */
public class KoşulluDurumlarVeKodBlokları {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(!((3 < 4 && "Sinan" == "Sinan") || 3.4 > 2.1));
